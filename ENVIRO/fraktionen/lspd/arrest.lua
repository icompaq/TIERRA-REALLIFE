...
function cuff_func(theMaker,Command,thePlayerName)
	if(isBeamter(theMaker))or(vioGetElementData(theMaker,"fraktion")==2)or(vioGetElementData(theMaker,"fraktion")==8)or(vioGetElementData(theMaker,"fraktion")==6)or(vioGetElementData(theMaker,"fraktion")==11)or(vioGetElementData(theMaker,"fraktion")==12)then
		local thePlayer=getPlayerFromIncompleteName(thePlayerName)
		if(thePlayer)then
				...
				if(logoutTable[string.lower(thePlayerName)])then
					...
					if((timestamp - 300) < logoutTable[string.lower(thePlayerName)][1])then
						if(reason)then
                            ...
                            local wantedsold=MySQL_SetVar("userdata", "Wanteds", wanteds, "Nickname = '" .. thePlayerName .. "'")
                            ...
                            if(wantedsold<=6)then
                                ...
                                if (not MySQL_SetVar("userdata", "Wanteds", wanteds, "Nickname = '" .. thePlayerName .. "'")) then
                                    ...
                                    showError(theMaker, "Fehler beim vergeben der Wanteds!")
                                end
                            else
                                showError(theMaker, "Dieser Spieler hat bereits 6 oder mehr Wanteds!")
                            end
