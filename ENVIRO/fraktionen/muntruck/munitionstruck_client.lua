...
function bestellenMuntGUI()
	...
	if(bestellwert~="")then
		...
		if(bestellwertnum>0 and bestellwertnum<250001)then
			...
			outputChatBox("Alter in den Munitionstruck passn nur mehr als 0 und weniger als 150000 Schuss?!",255,0,0)
		end	
	else
