...
function zeugnis_geben(thePlayer,cmd,toPlayerName,ids,notes,note2,note3,note4,note5,note6,note7,note8)
	if(vioGetElementData(thePlayer,"fraktion")==7 and vioGetElementData(thePlayer,"fraktionsrang")>4) or(isBeamter(thePlayer) and vioGetElementData(thePlayer,"fraktionsrang")>5)then
...
function refresh_zeugnis(thePlayer,cmd,toPlayerName)
	if(vioGetElementData(thePlayer,"fraktion")==7 and vioGetElementData(thePlayer,"fraktionsrang")>4)then
...
function mount_spawner(thePlayer)
	if(vioGetElementData(thePlayer,"fraktion")==7 and vioGetElementData(thePlayer,"fraktionsrang")>2)then
