...
addEventHandler("onClientResourceStart",resourceRoot,
    function()
        ...
        guiGridListSetItemText ( SuperShop_Grid[1], row, SuperShop_Colum[2], "Rubbellos", false, false )		
        guiGridListSetItemText ( SuperShop_Grid[1], row, SuperShop_Colum[3], "0.99", false, false )
