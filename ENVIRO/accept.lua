function accept_ticket_func(thePlayer,Command,types)
	if(types=="hotdog")then
		hotDogSeller=vioGetElementData(thePlayer,"hotDogSeller")
		hotDogSellerPrice=vioGetElementData(thePlayer,"hotDogSellerPrice")
		hotDogSellerMenge=vioGetElementData(thePlayer,"hotDogSellerMenge")
