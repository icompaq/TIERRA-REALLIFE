function find_func(thePlayer, Command, toPlayerName)
	if (vioGetElementData(thePlayer, "job")== 6 and vioGetElementData(thePlayer, "fraktion") == 0) or vioGetElementData(thePlayer, "job") == 7 or (isBeamter(thePlayer) and vioGetElementData(thePlayer, "Innendienst")) or(vioGetElementData(thePlayer, "fraktion") == 8) then
